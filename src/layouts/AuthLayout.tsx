...
const AuthLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      {/* Left side - Branding */}
      <motion.div 
        className="bg-gradient-to-br from-primary-600 to-primary-800 text-white md:w-1/2 p-8 flex flex-col justify-center items-center"
      ...
      >
        <div className="max-w-md mx-auto">
          <div className="flex items-center gap-3 mb-6">
            <Briefcase size={40} className="text-secondary-300" />
            <h1 className="text-3xl font-bold">BusinessPro</h1>
          </div>
